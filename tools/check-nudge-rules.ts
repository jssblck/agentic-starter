...
const fixtures: readonly Fixture[] = [
  ...
  {
    name: 'age private key in a file is blocked',
    rule: 'secrets-no-plaintext-age-identity',
    expected: 'Interrupt',
    input: 'content',
    fixture: 'secrets-age-identity-positive.txt',
    tool: 'Write',
    file: '.sops.yaml',
  },
  {
    name: 'age public recipient is allowed',
    rule: 'secrets-no-plaintext-age-identity',
    expected: 'Passthrough',
    input: 'content',
    fixture: 'secrets-age-identity-negative.txt',
    tool: 'Write',
    file: '.sops.yaml',
  },
  {
